...
%digest(self)
        ...
        \begin{class}[text width=6cm]{MD4}{4,0}
            ...
            \operation{\# \underline{\textunderscore f}(X, Y, Z)}
            \operation{\# \underline{\textunderscore g}(X, Y, Z)}
            \operation{\# \underline{\textunderscore h}(X, Y, Z)}
            \operation{\# \underline{\textunderscore round\textunderscore 1\textunderscore op}(A, B, C, D, X, s)}
            \operation{\# \underline{\textunderscore round\textunderscore 2\textunderscore op}(A, B, C, D, X, s)}
            \operation{\# \underline{\textunderscore round\textunderscore 3\textunderscore op}(A, B, C, D, X, s)}
        ...
        \begin{class}[text width=6cm]{MD5}{-3,0}
            ...
            \operation{\# \underline{\textunderscore g}(X, Y, Z)}
            \operation{\# \underline{\textunderscore h}(X, Y, Z)}
            \operation{\# \underline{\textunderscore i}(X, Y, Z)}
            \operation{\# \underline{\textunderscore round\textunderscore 1\textunderscore op}(A, B, C, D, X, s, i)}
            \operation{\# \underline{\textunderscore round\textunderscore 2\textunderscore op}(A, B, C, D, X, s, i)}
            \operation{\# \underline{\textunderscore round\textunderscore 3\textunderscore op}(A, B, C, D, X, s, i)}
            \operation{\# \underline{\textunderscore round\textunderscore 4\textunderscore op}(A, B, C, D, X, s, i)}
            \operation{\# \textunderscore update(self, X: List[int]) -\textgreater None}
        \end{class}
    \end{tikzpicture}
\end{document}
